...
| **AllowHostOnlyExtensions**   | `"IfRequested"` | 配置是在任意房间 (`"Always"`)，还是仅限 +25 协议房间 (`"IfRequested"`)，或不允许 (`"Never"`) 使用 [Host-Only 扩展](https://github.com/Innersloth-LLC/AmongUsModdingInformation#host-only-mods)。 |
